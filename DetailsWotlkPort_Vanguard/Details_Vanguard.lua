...
local function CreatePluginFrames (data)
	...
	function Vanguard:CreateTankBlock (index)
		...
		f:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tile = true, tileSize = 16, insets = {left = 0, right = 0, top = 0, bottom = 0}, edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1})
...
function Vanguard:OnEvent (_, event, arg1, token, time, who_serial, who_name, who_flags, _, alvo_serial, alvo_name, alvo_flags, _, spellid, spellname, spellschool, tipo)
	...
	if (event == "ADDON_LOADED") then
		...
		if (AddonName == "DetailsWotlkPort_Vanguard" or AddonName == "Details_Vanguard") then
