...
edFrame.DefaultBarTexture = "Interface\\AddOns\\DetailsWotlkPort\\images\\bar_serenity"
...
local function CreatePluginFrames(data)
	...
	local cooltip_menu = function()
		...
		gameCooltip:AddIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 1, 1, 20, 20, 0, 0.125, 0, 0.5)

		--chart
		gameCooltip:AddLine("Damage Graphic")
		gameCooltip:AddMenu(1, encounterDetails.Frame.switch, "graph")
		gameCooltip:AddIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 1, 1, 20, 20, 0.125*3, 0.125*4, 0, 0.5)

		--emotes
		gameCooltip:AddLine("Boss Emotes")
		gameCooltip:AddMenu(1, encounterDetails.Frame.switch, "emotes")
		gameCooltip:AddIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 1, 1, 20, 20, 0.125*4, 0.125*5, 0, 0.5)

		--phases
		gameCooltip:AddLine("Damage by Boss Phase")
		gameCooltip:AddMenu(1, encounterDetails.Frame.switch, "phases")
		gameCooltip:AddIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 1, 1, 20, 20,  0.125, 0.125*2, 0, 0.505625)
	...
	encounterDetails.ToolbarButton = Details.ToolBar:NewPluginToolbarButton(encounterDetails.OpenWindow, "Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\icon", Loc ["STRING_PLUGIN_NAME"], Loc ["STRING_TOOLTIP"], 16, 16, "ENCOUNTERDETAILS_BUTTON", cooltip_menu) --"Interface\\COMMON\\help-i"
...
--custom tooltip for dead details ---------------------------------------------------------------------------------------------------------
	...
	local function KillInfo(deathTable, row)
		...
		GameCooltip:AddStatusBar(0, 1, 1, 1, 1, 1, false, {value = 100, color = {.3, .3, .3, .5}, specialSpark = false, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})

		local statusBarBackground = {value = 100, color = {.21, .21, .21, 0.8}, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]}
		...
		if (lastcooldown) then
			...
			GameCooltip:AddStatusBar(0, 1, 1, 1, 1, 1, false, {value = 100, color = {.3, .3, .3, 1}, specialSpark = false, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})
		end
...
local backdrop_bar_onenter = {bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tile = true, tileSize = 16, edgeFile = "Interface\\DialogFrame\\UI-DialogBox-Border", edgeSize = 8, insets = {left = 1, right = 1, top = 0, bottom = 1}}
local backdrop_bar_onleave = {bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tile = true, tileSize = 16, insets = {left = 1, right = 1, top = 0, bottom = 1}}
...
function encounterDetails:OnEvent(self, event, ...)
	...
	elseif (event == "ADDON_LOADED") then
		...
		if (addonName == "DetailsWotlkPort_EncounterDetails" or addonName == "Details_EncounterDetails") then
