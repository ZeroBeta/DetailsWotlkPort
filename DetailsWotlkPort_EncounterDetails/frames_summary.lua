...
do --player damage taken
    ...
    local playerDamageTaken_OnEnterFunc = function(bar)
        ...
        for i = 1, #aggressorList do
            ...
            gameCooltip:AddStatusBar(damageDone / topDamage * 100, 1, red, green, blue, edFrame.CooltipStatusbarAlpha, false, {value = 100, color = {.21, .21, .21, 0.8}, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})
    ...
    local icon = detailsFramework:CreateImage(damageTakenScroll, "Interface\\AddOns\\DetailsWotlkPort\\images\\atributos_icones_damage", 20, 20, "overlay", {0.125*2, 0.125*3, 0, 1})
...
do --~ability ~damage taken by spell
    local spellDamage_OnEnterFunc = function(bar)
        ...
        for index, playerDamageTable in ipairs(targetActors) do
            ...
            if (actorClass) then
                ...
                GameCooltip:AddStatusBar(damageAmount / topValue * 100, 1, r, g, b, edFrame.CooltipStatusbarAlpha, false, {value = 100, color = {.21, .21, .21, 0.5}, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})
            else
                GameCooltip:AddStatusBar(damageAmount / topValue * 100, 1, 1, 1, 1, edFrame.CooltipStatusbarAlpha, false, {value = 100, color = {.21, .21, .21, 0.8}, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})
            end
            ...
            if (specId) then
                ...
                if (coords) then
                    GameCooltip:AddIcon("Interface\\AddOns\\DetailsWotlkPort\\images\\classes_small", nil, 1, encounterDetails.CooltipLineHeight-2, encounterDetails.CooltipLineHeight-2,(coords[1]),(coords[2]),(coords[3]),(coords[4]))
                end
            end
        end
    ...
    local icon = detailsFramework:CreateImage(spellDamageScroll, "Interface\\AddOns\\DetailsWotlkPort\\images\\atributos_icones_damage", 20, 20, "overlay", {0.125*7, 1, 0, 1})
...
do --enemy damage taken ~adds ~enemies
    local enemyAdds_OnEnterFunc = function(bar)
        ...
        for i = 1, #aggressors do
            ...
            GameCooltip:AddStatusBar(damageDoneToThisEnemy / topDamage * 100, 1, red, green, blue, .834, false, {value = 100, color = {.21, .21, .21, 0.8}, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})
    ...
    local icon = detailsFramework:CreateImage(enemiesScroll, "Interface\\AddOns\\DetailsWotlkPort\\images\\atributos_icones_damage", 20, 20, "overlay", {0.125*5, 0.125*6, 0, 1})
...
do -- ~interrupt
    ...
    local interrupt_OnEnterFunc = function(bar)
        ...
        for index, actorInterruptTable in ipairs(interruptsByTable) do
            ...
            if (texture) then
                ...
                GameCooltip:AddIcon("Interface\\AddOns\\DetailsWotlkPort\\images\\classes_small", nil, 1, encounterDetails.CooltipLineHeight, encounterDetails.CooltipLineHeight, coords[1], coords[2], coords[3], coords[4])
            end
        end
    ...
    local icon = detailsFramework:CreateImage(interruptsScroll, "Interface\\AddOns\\DetailsWotlkPort\\images\\atributos_icones_misc", 20, 20, "overlay", {0.125*2, 0.125*3, 0, 1})
...
do -- ~dispel
    ...
    local icon = detailsFramework:CreateImage(dispelScroll, "Interface\\AddOns\\DetailsWotlkPort\\images\\atributos_icones_misc", 20, 20, "overlay", {0.125*3, 0.125*4, 0, 1})
...
do --~deaths ~dead
    ...
    local statusBarBackground = {value = 100, color = {.11, .11, .11, 0.8}, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]}
	...
	local deathLog_OnEnterFunc = function(bar)
		...
		GameCooltip:AddIcon("Interface\\AddOns\\DetailsWotlkPort\\images\\small_icons", 1, 1, iconSize, iconSize, .75, 1, 0, 1)
		GameCooltip:AddStatusBar(0, 1, .5, .5, .5, .5, false, {value = 100, color = {.5, .5, .5, 1}, specialSpark = false, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar4_vidro]]})
		...
		if (battleRess) then
			...
			GameCooltip:AddStatusBar(0, 1, .5, .5, .5, .5, false, {value = 100, color = {.3, .3, .5, 1}, specialSpark = false, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})
		end
		...
		if (lastCooldown) then
			if (lastCooldown[2] > 0) then --spellId
                ...
                GameCooltip:AddStatusBar(0, 1, 1, 1, 1, 1, false, {value = 100, color = {.3, .5, .3, 1}, specialSpark = false, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})
			else
    ...
    local icon = detailsFramework:CreateImage(deathsScroll, "Interface\\AddOns\\DetailsWotlkPort\\images\\atributos_icones_misc", 20, 20, "overlay", {0.125*4, 0.125*5, 0, 1})
