...
local barDivEmotes = detailsFramework:CreateImage(edFrame, "Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_bg", 4, 480, "artwork", {724/1024, 728/1024, 0, 245/512})
...
local onEnterRow = function(self)
    self:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tile = true, tileSize = 16})
...
for i = 1, CONST_EMOTES_MAX_LINES do
    ...
    line:SetHeight(14)
    line:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tile = true, tileSize = 16})
...
local segmentIcon = [[Interface\AddOns\DetailsWotlkPort\images\icons]]
...
reportEmoteButton:SetIcon([[Interface\AddOns\DetailsWotlkPort\images\report_button]], 8, 14, nil, {0, 1, 0, 1}, nil, 4, 2)
