do
	...
	Details.EncounterDetailsTempWindow = function(encounterDetails)
		...
		local buildOptionsPanel = function()
			local pluginIcon = "Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\icon"
		...
		edFrame.bosFrameBackgroundTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\background]], true)
		...
		headerFrame:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tileSize = 64, tile = true})
		...
		do
			...
			edFrame.buttonSwitchNormal:SetIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 18, 18, "overlay", {0, 32/256, 0, 0.505625})
			edFrame.buttonSwitchNormal:SetTemplate(detailsFramework:GetTemplate("button", "DETAILS_PLUGIN_BUTTONSELECTED_TEMPLATE"))
			edFrame.buttonSwitchNormal:SetWidth(BUTTON_WIDTH)
				...
				edFrame.buttonSwitchNormalBreakdown:SetIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 18, 18, "overlay", {0, 32/256, 0, 0.505625})
			...
			edFrame.buttonSwitchPhases:SetIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 18, 18, "overlay", {65/256, 96/256, 0, 0.505625})
			edFrame.buttonSwitchPhases:SetTemplate(detailsFramework:GetTemplate("button", "DETAILS_PLUGIN_BUTTON_TEMPLATE"))
			edFrame.buttonSwitchPhases:SetWidth(BUTTON_WIDTH)
				...
				edFrame.buttonSwitchPhasesBreakdown:SetIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 18, 18, "overlay", {65/256, 96/256, 0, 0.505625})
			...
			edFrame.buttonSwitchGraphic:SetIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 18, 18, "overlay", {97/256, 128/256, 0, 0.505625})
			edFrame.buttonSwitchGraphic:SetTemplate(detailsFramework:GetTemplate("button", "DETAILS_PLUGIN_BUTTON_TEMPLATE"))
			edFrame.buttonSwitchGraphic:SetWidth(BUTTON_WIDTH)
				...
				edFrame.buttonSwitchGraphicBreakdown:SetIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 18, 18, "overlay", {97/256, 128/256, 0, 0.505625})
			...
			edFrame.buttonSwitchBossEmotes:SetIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 18, 18, "overlay", {129/256, 160/256, 0, 0.505625})
			edFrame.buttonSwitchBossEmotes:SetTemplate(detailsFramework:GetTemplate("button", "DETAILS_PLUGIN_BUTTON_TEMPLATE"))
			edFrame.buttonSwitchBossEmotes:SetWidth(BUTTON_WIDTH)
				...
				edFrame.buttonSwitchBossEmotesBreakdown:SetIcon("Interface\\AddOns\\DetailsWotlkPort_EncounterDetails\\images\\boss_frame_buttons", 18, 18, "overlay", {129/256, 160/256, 0, 0.505625})
