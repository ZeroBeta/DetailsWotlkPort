	...
	function compareTwo.InstallAdvancedCompareWindow()
		...
		local playerComparisonCreate = function(tab, comparePlugin)
			...
			local mainTabSelectorRadioOptions = {
				{
					...
					texture = [[Interface\AddOns\DetailsWotlkPort\images\icons2.png]],
					width = 32,
					height = 32,
					text_size = 20,
			...
			local radioGroupSettings = {
				...
				checked_texture = [[Interface\AddOns\DetailsWotlkPort\images\checked_texture1]],
...
---------------------------------------------------------------------------------------------------------------------------------------
	...
	function compareTwo:OnEvent(_, event, ...)
		if (event == "ADDON_LOADED") then
			...
			if (AddonName == "DetailsWotlkPort_Compare2" or AddonName == "Details_Compare2") then
