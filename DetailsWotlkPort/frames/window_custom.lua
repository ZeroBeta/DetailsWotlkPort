...
--create the window
	...
	function _detalhes:InitializeCustomDisplayWindow()
		...
		DetailsCustomPanel.__icon = [[Interface\AddOns\DetailsWotlkPort\images\icons]]
	...
	function _detalhes:OpenCustomDisplayWindow()
		if (not _G.DetailsCustomPanel or not DetailsCustomPanel.Initialized) then
			...
			--menu title bar
				...
				titlebar:SetBackdrop({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tileSize = 64, tile = true})
			...
			--background
				...
				customWindow.bg1:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\background]], true)
				...
				customWindow:SetBackdrop({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tileSize = 64, tile = true})
			...
			for i = 1, 10 do
				...
				if (attributes [i]) then
					...
					button.icon:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\custom_icones]])
