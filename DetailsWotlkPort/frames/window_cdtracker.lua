...
function Details222.CooldownTracking.GetOrCreateNewCooldownLine(cooldownFrame, lineId)
    ...
    if (cooldownLine) then
        ...
        cooldownLine = DF:CreateTimeBar(cooldownFrame, [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]], Details.ocd_tracker.width-2, Details.ocd_tracker.height-2, 100, nil, cooldownFrame:GetName() .. "CDFrame" .. lineId)
