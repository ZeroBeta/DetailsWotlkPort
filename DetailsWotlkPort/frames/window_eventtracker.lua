	...
	--> scroll frame
		...
		local get_player_icon = function(spec, class)
			...
			elseif (class) then
				...
				return [[Interface\AddOns\DetailsWotlkPort\images\classes_plus]], 0.50390625, 0.62890625, 0, 0.125
			end
		end
			...
			for i = 1, total_lines do
				...
				if (ability) then
					...
					if (ability [ABILITYTABLE_SPELLTYPE] == SPELLTYPE_COOLDOWN) then
						...
						line.ActionIcon:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\event_tracker_icons]])
