...
function Details:InitializePlaterIntegrationWindow()
    ...
    DetailsPlaterIntegrationPanel.__icon = [[Interface\AddOns\DetailsWotlkPort\images\plater_icon]]
...
function Details.OpenPlaterIntegrationWindow()
    if (not DetailsPlaterIntegrationPanel or not DetailsPlaterIntegrationPanel.Initialized) then
        ...
        titleBackground.bg1:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\background]])
        ...
        titleBackground:SetBackdrop({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tileSize = 64, tile = true})
        ...
        local platerImage = DF:CreateImage(titleBackground, "Interface\\AddOns\\DetailsWotlkPort\\images\\plater_image")
