...
function Details:InitializeRunCodeWindow()
    ...
    --DetailsRunCodePanel.__icon = [[Interface\AddOns\DetailsWotlkPort\images\lua_logo]]
    detailsRunCodePanel.__icon = [[Interface\AddOns\DetailsWotlkPort\images\run_code]]
