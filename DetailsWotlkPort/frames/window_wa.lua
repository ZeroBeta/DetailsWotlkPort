...
function _detalhes:OpenAuraPanel (spellid, spellname, spellicon, encounterid, triggertype, auratype, other_values)
    ...
    if (not DetailsAuraPanel or not DetailsAuraPanel.Initialized) then
        ...
        f.bg1:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\background]], true)
        f.bg1:SetAlpha(0.8)
        ...
        f.bg1:SetAllPoints()
        f:SetBackdrop({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tileSize = 64, tile = true})
        ...
        local Icon_IconAuraType = fw:CreateImage(f, [[Interface\AddOns\DetailsWotlkPort\images\icons2]], 32, 32, "overlay", {200/512, 232/512, 336/512, 368/512}, nil, nil)
        Icon_IconAuraType:SetPoint("topleft", aura_type_label, "bottomleft", 10, -16)
        
        local Icon_StatusbarAuraType = fw:CreateImage(f, [[Interface\AddOns\DetailsWotlkPort\images\icons2]], 92, 12, "overlay", {235/512, 327/512, 336/512, 348/512}, nil, nil)
        Icon_StatusbarAuraType:SetPoint("topleft", aura_type_label, "bottomleft", 60, -26)
        
        local Icon_TextOnlyAuraType = fw:CreateImage(f, [[Interface\AddOns\DetailsWotlkPort\images\icons2]], 57, 8, "overlay", {250/512, 306/512, 360/512, 367/512}, nil, nil)
        ...
        Icon_IconAuraTypeButton:SetBackdrop({edgeFile = [[Interface\AddOns\DetailsWotlkPort\images\dotted]], edgeSize = 1, bgFile = [[Interface\Tooltips\UI-Tooltip-Background]], tileSize = 64, tile = true})
        ...
        Icon_StatusbarAuraTypeButton:SetBackdrop({edgeFile = [[Interface\AddOns\DetailsWotlkPort\images\dotted]], edgeSize = 1, bgFile = [[Interface\Tooltips\UI-Tooltip-Background]], tileSize = 64, tile = true})
        ...
        Icon_TextOnlyAuraTypeButton:SetBackdrop({edgeFile = [[Interface\AddOns\DetailsWotlkPort\images\dotted]], edgeSize = 1, bgFile = [[Interface\Tooltips\UI-Tooltip-Background]], tileSize = 64, tile = true})
        ...
        local folder_icon = [[Interface\AddOns\DetailsWotlkPort\images\icons]]
