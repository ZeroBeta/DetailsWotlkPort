...
--frame creation function
	local defaultSkin = function()
		...
		for i = 1, 9 do --window.max_last_buttons
			...
			recentReportButton:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tile = true, tileSize = 16,
		...
		window.slider.thumb:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\icons2]])
