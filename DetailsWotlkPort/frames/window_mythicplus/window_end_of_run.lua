...
local createLootSquare = function(playerBanner, name, parent, lootIndex)
	...
	shadowTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus_banner_mask.png]])
...
local createPlayerBanner = function(parent, name, index)
	...
	local createPlayerBannerBackgroundTexture = function(playerBanner)
		...
		backgroundBannerTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus_banner_mask.png]])
		...
		maskTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus_banner_mask.png]])
	...
	do
		...
		bannerFlash:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus_banner_mask.png]])
    ...
    dungeonBorderTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], nil, nil, "TRILINEAR")
...
function mythicDungeonFrames.ShowEndOfMythicPlusPanel()
	...
	if (not mythicDungeonFrames.ReadyFrame) then
		...
		backgroundGradient:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\gradient_black_transparent.png]], nil, nil, "TRILINEAR")
...
--/run _G.MythicDungeonFrames.ShowEndOfMythicPlusPanel()
		...
		previewImage:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\mythicp_plugin_panel.png]], nil, nil, "TRILINEAR")
		...
		headerTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], nil, nil, "TRILINEAR")
		...
		elapsedTimeIcon:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], nil, nil, "TRILINEAR")
		...
		outOfCombatIcon:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], nil, nil, "TRILINEAR")
		...
		sandTimeIcon:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], nil, nil, "TRILINEAR")
		...
		strongArmIcon:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], nil, nil, "TRILINEAR")
		...
		normalTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], nil, nil, "TRILINEAR")
		...
		pushedTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], nil, nil, "TRILINEAR")
		...
		--auto close time bar
		local autoCloseTimeBar = detailsFramework:CreateTimeBar(contentFrame, [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]])
		...
		readyFrame.ShowBreakdownButton:SetIcon([[Interface\AddOns\DetailsWotlkPort\images\icons2.png]], 16, 16, "overlay", {84/512, 120/512, 153/512, 187/512}, {.7, .7, .7, 1}, nil, 0, 0)
		...
		readyFrame.ShowChartButton:SetIcon([[Interface\AddOns\DetailsWotlkPort\images\end_of_mplus.png]], 16, 16, "overlay", {153/512, 185/512, 0, 32/512}, {1, 1, 1, 1}, nil, 0, 0)
	...
	if (Details222.MythicPlus.OnTime) then
		...
		C_Timer.After(0.020, function()
			--PlaySoundFile([[Interface\AddOns\DetailsWotlkPort\sounds\bassdrop2.mp3]])
		end)
	else
