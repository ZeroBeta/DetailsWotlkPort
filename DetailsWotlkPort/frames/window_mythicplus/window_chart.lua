...
function mythicDungeonCharts.ShowChart()
	if (not mythicDungeonCharts.Frame) then
		...
		--titlebar when minimized
			...
			titlebarMinimized:SetBackdrop({edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tileSize = 64, tile = true})
