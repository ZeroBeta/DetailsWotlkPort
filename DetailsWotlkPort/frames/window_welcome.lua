	...
	if (not window) then
		...
		window:SetScript("OnHide", function()
			...
			if (DetailsFramework.IsClassicWow()) then
				...
				new_instance.row_info.icon_file = [[Interface\AddOns\DetailsWotlkPort\images\classes_small]]
		...
		logotipo:SetTexture([[Interface\Addons\DetailsWotlkPort\images\logotipo]])
...
--Skins Page page 2
	...
	--SKINS
		...
		skins_image:SetTexture([[Interface\Addons\DetailsWotlkPort\images\icons2]])
		...
		-- window color
			...
			window_color:SetIcon ([[Interface\AddOns\DetailsWotlkPort\images\icons]], 14, 14, nil, {434/512, 466/512, 277/512, 307/512}, nil, 4, 2)
...
--numeral system page 3
		...
		sword_icon2:SetTexture([[Interface\Addons\DetailsWotlkPort\images\icons2]])
...
-- stretcher
		...
		stretch_image:SetTexture([[Interface\Addons\DetailsWotlkPort\images\icons]])
...
-- window button
		...
		instance_button_image:SetTexture([[Interface\Addons\DetailsWotlkPort\images\icons]])
...
-- bookmark
		...
		shortcut_image2:SetTexture([[Interface\Addons\DetailsWotlkPort\images\icons]])
		...
		--local desc_anchor_topleft = _detalhes.gump:NewImage(bookmark_frame, [[Interface\AddOns\DetailsWotlkPort\images\options_window]], 75, 106, "artwork", {0.19921875, 0.2724609375, 0.6796875, 0.783203125}, "descAnchorBottomLeftImage", "$parentDescAnchorBottomLeftImage") --204 696 279 802
		--desc_anchor_topleft:SetPoint("topleft", bookmark_frame, "topleft", -5, 5)

		--local desc_anchor_bottomleft = _detalhes.gump:NewImage(bookmark_frame, [[Interface\AddOns\DetailsWotlkPort\images\options_window]], 75, 106, "artwork", {0.2724609375, 0.19921875, 0.783203125, 0.6796875}, "descAnchorTopLeftImage", "$parentDescAnchorTopLeftImage") --204 696 279 802
...
-- group windows
		...
		snap_image1:SetTexture([[Interface\Addons\DetailsWotlkPort\images\icons]])
...
-- tooltip shift alt ctrl
		...
		micro_image1:SetTexture([[Interface\Addons\DetailsWotlkPort\images\icons]])
...
--page 11
		...
		plugins_image1:SetTexture([[Interface\Addons\DetailsWotlkPort\images\icons2]])
