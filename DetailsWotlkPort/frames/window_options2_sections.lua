...
local font_select_icon, font_select_texcoord = [[Interface\AddOns\DetailsWotlkPort\images\icons]], {472/512, 513/512, 186/512, 230/512}

--store the current instance being edited
local currentInstance
Details222.OptionsPanel.maxSectionIds = Details222.OptionsPanel.maxSectionIds or 20
    ...
    local buildSection = function(sectionFrame)
        ...
        --auto erase | erase data
            ...
            local eraseDataOptions = {
                {value = 1, label = Loc ["STRING_OPTIONS_ED1"], onclick = onSelectEraseData, icon = [[Interface\Addons\DetailsWotlkPort\Images\reset_button2]]},
                {value = 2, label = Loc ["STRING_OPTIONS_ED2"], onclick = onSelectEraseData, icon = [[Interface\Addons\DetailsWotlkPort\Images\reset_button2]]},
                {value = 3, label = Loc ["STRING_OPTIONS_ED3"], onclick = onSelectEraseData, icon = [[Interface\Addons\DetailsWotlkPort\Images\reset_button2]]},
            }
        ...
        local sectionOptions = {
            ...
            {--ungroup instance
                ...
                icontexture = [[Interface\AddOns\DetailsWotlkPort\images\icons]],
        ...
        --skin selection
            ...
            local buildSkinMenu = function()
                ...
                for skin_name, skin_table in pairs(Details.skins) do
                    local file = skin_table.file:gsub([[Interface\AddOns\DetailsWotlkPort\images\skins\]], "")
...
do
    ...
    local texture_icon = [[Interface\AddOns\DetailsWotlkPort\images\icons]]
...
do
    ...
    --custom title bar texture
        ...
        local buildIconStyleMenu = function()
            local iconMenu = {
                {value = "Interface\\AddOns\\DetailsWotlkPort\\images\\toolbar_icons", label = "Set 1", icon = "Interface\\AddOns\\DetailsWotlkPort\\images\\toolbar_icons", texcoord = {0, 0.125, 0, 1}, onclick = on_select_icon_set},
                {value = "Interface\\AddOns\\DetailsWotlkPort\\images\\toolbar_icons_shadow", label = "Set 2", icon = "Interface\\AddOns\\DetailsWotlkPort\\images\\toolbar_icons_shadow", texcoord = {0, 0.125, 0, 1}, onclick = on_select_icon_set},
                {value = "Interface\\AddOns\\DetailsWotlkPort\\images\\toolbar_icons_2", label = "Set 3", icon = "Interface\\AddOns\\DetailsWotlkPort\\images\\toolbar_icons_2", texcoord = {0, 0.125, 0, 1}, onclick = on_select_icon_set},
                {value = "Interface\\AddOns\\DetailsWotlkPort\\images\\toolbar_icons_2_shadow", label = "Set 4", icon = "Interface\\AddOns\\DetailsWotlkPort\\images\\toolbar_icons_2_shadow", texcoord = {0, 0.125, 0, 1}, onclick = on_select_icon_set},
            }
            return iconMenu
        end
    ...
    local buildSection = function(sectionFrame)
        local sectionOptions = {
            ...
            {--button orange gear
                ...
                name = "",
                --desc = "",
                icontexture = [[Interface\AddOns\DetailsWotlkPort\images\toolbar_icons]],
...
do
    local buildSection = function(sectionFrame)
        ...
        local allExistentToolbarPlugins = {
            {"DETAILS_PLUGIN_CHART_VIEWER", "DetailsWotlkPort_ChartViewer", "Chart Viewer", "View combat data in handsome charts.", "https://www.curseforge.com/wow/addons/details-chart-viewer-plugin"},
            {"DETAILS_PLUGIN_DEATH_GRAPHICS", "DetailsWotlkPort_DeathGraphs", "Advanced Death Logs", "Encounter endurance per player (who's dying more), deaths timeline by enemy spells and regular death logs.", "https://www.curseforge.com/wow/addons/details-advanced-death-logs-plug"},
...
do
    local buildSection = function(sectionFrame)
        ...
        --create preview
            ...
            icon1:SetTexture("Interface\\AddOns\\DetailsWotlkPort\\images\\icons")
            ...
            icon2:SetTexture("Interface\\AddOns\\DetailsWotlkPort\\images\\icons")
            ...
            icon3:SetTexture("Interface\\AddOns\\DetailsWotlkPort\\images\\icons")
            ...
            icon4:SetTexture("Interface\\AddOns\\DetailsWotlkPort\\images\\icons")
            ...
            L1:SetTexture("Interface\\AddOns\\DetailsWotlkPort\\images\\icons")
            ...
            L2:SetTexture("Interface\\AddOns\\DetailsWotlkPort\\images\\icons")
            ...
            L3:SetTexture("Interface\\AddOns\\DetailsWotlkPort\\images\\icons")
            ...
            L4:SetTexture("Interface\\AddOns\\DetailsWotlkPort\\images\\icons")
            ...
            {--enable wallpaper
                ...
                set = function(self, fixedparam, value)
                    ...
                    if (value) then
                        ...
                        if (not currentInstance.wallpaper.texture) then
                            currentInstance.wallpaper.texture = "Interface\\AddOns\\DetailsWotlkPort\\images\\background"
                        end
...
do
    local buildSection = function(sectionFrame)
        ...
        --streamer plugin - a.k.a. Action Tracker
			...
			local streamerTitleImage = DF:CreateImage(sectionFrame, [[Interface\AddOns\DetailsWotlkPort\images\icons2.blp]], 268*0.75, 59*0.75, "overlay", {0, 268/512, 454/512, 1})
		...
		--event tracker
			...
			local eventTrackerTitleImage = DF:CreateImage(sectionFrame, [[Interface\AddOns\DetailsWotlkPort\images\icons2]], 256, 50, "overlay", {0.5, 1, 134/512, 184/512})
		...
		--arena kamehameha bar
			...
			local currentDPSTitleImage = DF:CreateImage(sectionFrame, [[Interface\AddOns\DetailsWotlkPort\images\icons2]], 256, 32, "overlay", {0/512, 256/512, 421/512, 453/512})
...
--panel
    ...
    big_code_editor:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1,tile = 1, tileSize = 16})
    ...
    big_code_editor2:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1,tile = 1, tileSize = 16})
    ...
    --add panel
        ...
        addframe:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1,tile = 1, tileSize = 16})
    ...
    --open import panel button
        ...
        importframe:SetBackdrop({bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1,tile = 1, tileSize = 16})
