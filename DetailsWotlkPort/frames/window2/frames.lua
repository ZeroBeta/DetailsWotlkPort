...
local defaultSettings = {
    ...
    lines = {
        ...
        icon_spec = [[Interface\AddOns\DetailsWotlkPort\images\spec_icons_normal]], --always show the spec if the unit spec is known
        icon_class = [[Interface\AddOns\DetailsWotlkPort\images\classes_small]], --fallback to class texture if spec is unknown
...
local createLineForWindow = function(scrollFrame, lineId) --~line
    ...
    do --statusbar textures
        ...
        overlayTexture:SetTexture([[Interface/AddOns/DetailsWotlkPort/images/overlay_indicator_1]])
...
function AllInOneWindow:CreateWindowFrame() --~create
    ...
    closeButton.Icon:SetTexture([[Interface\AddOns\DetailsWotlkPort\assets\textures\icons\close.png]])
    ...
    optionsButton.Icon:SetTexture([[Interface\AddOns\DetailsWotlkPort\assets\textures\icons\wrench.png]])
