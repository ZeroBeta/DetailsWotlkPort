...
local frame_backdrop = {edgeFile = [[Interface\Buttons\WHITE8X8]], edgeSize = 1, bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tileSize = 64, tile = true}
...
local compare_create = function(tab, frame)
    ...
    local create_bar = function(name, parent, index, main, is_target)
        ...
        bar:SetStatusBarTexture([[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]])
    ...
    local create_tooltip = function(name)
        ...
        local bg_texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_background]]
        local bg_alpha = 1
        local bg_height = 12
    ...
    local create_tooltip_target = function(name)
        ...
        function tooltip:CreateBar(index)
            ...
            bg_line1:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\bar_background]])
...
local iconTableCompare = {
    texture = [[Interface\AddOns\DetailsWotlkPort\images\icons]],
