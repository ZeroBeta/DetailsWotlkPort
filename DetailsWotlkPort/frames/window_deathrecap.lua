...
local create_deathrecap_line = function(parent, n)
	...
	backgroundTexture:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\deathrecap_background]])
	...
	TopFader:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\deathrecap_background_top]])
	...
	if (n == 10) then
		...
		backgroundTexture2:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\deathrecap_background_bottom]])
