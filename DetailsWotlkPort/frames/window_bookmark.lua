...
function Details:OpenBookmarkConfig()
    ...
    if (not _G.DetailsBookmarkManager) then
        ...
        local button_backdrop = {bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background]], tile = true, tileSize = 64, insets = {left=0, right=0, top=0, bottom=0}}
        ...
        for i = 1, 40 do
            ...
            local bg_texture = DF:CreateImage(set, [[Interface\AddOns\DetailsWotlkPort\images\bar_skyline]], 135, 30, "background")
        ...
        function panel:Refresh()
            ...
            for i = 1, 40 do
                ...
                if (bookmark and bookmark.atributo and bookmark.sub_atributo) then
                    ...
                    this_block.label.text = "-- x -- x --"
                    this_block.icon.texture = [[Interface\AddOns\DetailsWotlkPort\images\icons]]
