...
Details.TextureAtlas = {
    ...
    ["segment-icon-mythicplus"] = {
        file = [[Interface\AddOns\DetailsWotlkPort\images\icons]],
        width = 14,
        height = 10,
    ...
    ["segment-icon-empty"] = {
        file = [[Interface\AddOns\DetailsWotlkPort\images\empty16]],
        width = 12,
        height = 12,
        nativeWidth = 16,
        nativeHeight = 16,
    ...
    ["iconmask"] = {
        file = [[Interface\AddOns\DetailsWotlkPort\images\common-iconmask.png]],
        width = 64,
        height = 64,
        leftTexCoord = 0,
        rightTexCoord = 1,
