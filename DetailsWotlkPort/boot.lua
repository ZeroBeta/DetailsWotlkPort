...
-- POLYFILLS FOR ANIMATION AND UI (injected from Animation.lua since it wasn't loading)
-- Animation API compatibility for WotLK 3.3.5a
do
	-- print("|cFF00FF00POLYFILLS EXECUTING IN BOOT.LUA|r")
	...
	-- SetScale polyfill for textures
	...
	-- AddMaskTexture polyfill for frames
	local function AddPolyfillsToMetatable(objectType)
		...
		if not mt.SetIgnoreParentScale then
			mt.SetIgnoreParentScale = function(self, ignore)
			end
		end
	end
...
do
	...
	--containers
		...
		--tooltip
			...
			_detalhes.tooltip_target_icon = {file = [[Interface\Addons\DetailsWotlkPort\images\icons]], coords = {0, 0.03125, 0.126953125, 0.15625}}

		--icons
			_detalhes.attribute_icons = [[Interface\AddOns\DetailsWotlkPort\images\atributos_icones]]
...
--functions
	...
	--register textures and fonts for shared media
		...
		--default bars
		SharedMedia:Register("statusbar", "Details Hyanda Reverse", [[Interface\AddOns\DetailsWotlkPort\images\bar_textures\bar_hyanda_reverse.png]])
		SharedMedia:Register("statusbar", "You Are the Best!", [[Interface\AddOns\DetailsWotlkPort\images\bar_textures\bar_best.png]])
		SharedMedia:Register("statusbar", "Details Hyanda", [[Interface\AddOns\DetailsWotlkPort\images\bar_hyanda]])

		SharedMedia:Register("statusbar", "Details D'ictum", [[Interface\AddOns\DetailsWotlkPort\images\bar4]])
		SharedMedia:Register("statusbar", "Details Vidro", [[Interface\AddOns\DetailsWotlkPort\images\bar4_vidro]])
		SharedMedia:Register("statusbar", "Details D'ictum (reverse)", [[Interface\AddOns\DetailsWotlkPort\images\bar4_reverse]])

		--flat bars
		SharedMedia:Register("statusbar", "Skyline", [[Interface\AddOns\DetailsWotlkPort\images\bar_skyline]])

		SharedMedia:Register("statusbar", "Details Serenity", [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]])
		SharedMedia:Register("statusbar", "BantoBar", [[Interface\AddOns\DetailsWotlkPort\images\BantoBar]])
		SharedMedia:Register("statusbar", "Skyline Compact", [[Interface\AddOns\DetailsWotlkPort\images\bar_textures\bar_skyline_compact.png]])
		...
		SharedMedia:Register("statusbar", "DGround", [[Interface\AddOns\DetailsWotlkPort\images\bar_background]])
		SharedMedia:Register("statusbar", "Details Flat", [[Interface\AddOns\DetailsWotlkPort\images\bar_background]])
		SharedMedia:Register("statusbar", "Splitbar", [[Interface\AddOns\DetailsWotlkPort\images\bar_textures\split_bar]])
		SharedMedia:Register("statusbar", "Details2020", [[Interface\AddOns\DetailsWotlkPort\images\bar_textures\texture2020]])
		SharedMedia:Register("statusbar", "Left White Gradient", [[Interface\AddOns\DetailsWotlkPort\images\bar_textures\gradient_white_10percent_left]])
		SharedMedia:Register("statusbar", "Details! Slash", [[Interface\AddOns\DetailsWotlkPort\images\bar_textures\bar_of_bars.png]])

		--window bg and bar order
		SharedMedia:Register("background", "Details Ground", [[Interface\AddOns\DetailsWotlkPort\images\background]])
		SharedMedia:Register("border", "Details BarBorder 1", [[Interface\AddOns\DetailsWotlkPort\images\border_1]])
		SharedMedia:Register("border", "Details BarBorder 2", [[Interface\AddOns\DetailsWotlkPort\images\border_2]])
		SharedMedia:Register("border", "Details BarBorder 3", [[Interface\AddOns\DetailsWotlkPort\images\border_3]])
		SharedMedia:Register("border", "1 Pixel", [[Interface\Buttons\WHITE8X8]])

		--misc fonts
		SharedMedia:Register("font", "Oswald", [[Interface\Addons\DetailsWotlkPort\fonts\Oswald-Regular.ttf]])
		SharedMedia:Register("font", "Nueva Std Cond", [[Interface\Addons\DetailsWotlkPort\fonts\Nueva Std Cond.ttf]])
		SharedMedia:Register("font", "Accidental Presidency", [[Interface\Addons\DetailsWotlkPort\fonts\Accidental Presidency.ttf]])
		SharedMedia:Register("font", "TrashHand", [[Interface\Addons\DetailsWotlkPort\fonts\TrashHand.TTF]])
		SharedMedia:Register("font", "Harry P", [[Interface\Addons\DetailsWotlkPort\fonts\HARRYP__.TTF]])
		SharedMedia:Register("font", "FORCED SQUARE", [[Interface\Addons\DetailsWotlkPort\fonts\FORCED SQUARE.ttf]])

		SharedMedia:Register("sound", "Details Gun1", [[Interface\Addons\DetailsWotlkPort\sounds\sound_gun2.ogg]])
		SharedMedia:Register("sound", "Details Gun2", [[Interface\Addons\DetailsWotlkPort\sounds\sound_gun3.ogg]])
		SharedMedia:Register("sound", "Details Jedi1", [[Interface\Addons\DetailsWotlkPort\sounds\sound_jedi1.ogg]])
		SharedMedia:Register("sound", "Details Whip1", [[Interface\Addons\DetailsWotlkPort\sounds\sound_whip1.ogg]])
		SharedMedia:Register("sound", "Details Horn", [[Interface\Addons\DetailsWotlkPort\sounds\Details Horn.ogg]])

		SharedMedia:Register("sound", "Details Warning", [[Interface\Addons\DetailsWotlkPort\sounds\Details Warning 100.ogg]])
		SharedMedia:Register("sound", "Details Truck", [[Interface\Addons\DetailsWotlkPort\sounds\Details Truck.ogg]])
		SharedMedia:Register("sound", "Details Bass Drop", [[Interface\Addons\DetailsWotlkPort\sounds\bassdrop2.mp3]])
