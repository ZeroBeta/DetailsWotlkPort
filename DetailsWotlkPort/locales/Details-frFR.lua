...
L["STRING_WELCOME_31"] = "|cFFFFFF00Cliquer à droite|r n'importe où dans la fenêtre affiche le panneau |cFFFFAA00Marque-pages|r. |cFFFFFF00Clic droit à nouveau|r ferme le panneau ou choisit un autre affichage si on clique sur une icône. |cFFFFFF00Clic droit|r sur la barre de titre pour ouvrir le panneau 'Tous les affichages'. |TInterface\\AddOns\\DetailsWotlkPort\\images\\key_ctrl:14:30:0:0:64:64:0:64:0:40|t + clic droit pour fermer la fenêtre."
