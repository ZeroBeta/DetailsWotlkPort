...
L["STRING_WELCOME_31"] = "|cFFFFFF00Tasto destro|r ovunque nella finestra per mostrare il pannello del |cFFFFAA00Bookmark|r. |cFFFFFF00Right premere di nuovo|r chiude il pannello o sceglie un altro display se premuto sull'icona. |cFFFFFF00Tasto destro|r sulla barra del titolo apre il pannello 'Tutti i Display' |TInterface\\AddOns\\DetailsWotlkPort\\images\\key_ctrl:14:30:0:0:64:64:0:64:0:40|t + Tasto destro per choidere la finestra"
