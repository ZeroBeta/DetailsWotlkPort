...
--internal functions
	...
	function Details:AddTooltipBackgroundStatusbar(side, value, useSpark, statusBarColor)
		...
		if (not side) then
			...
			GameCooltip:AddStatusBar(value, 1, r, g, b, a, useSpark, {value = 100, color = {rBG, gBG, bBG, aBG}, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_serenity]]})
		else
...
-- /run local a,b=Details.tooltip.header_statusbar,0.3;a[1]=b;a[2]=b;a[3]=b;a[4]=0.8;
	...
	local backdrop = {bgFile = [[Interface\AddOns\DetailsWotlkPort\images\background83.png]], edgeFile = [[Interface\Buttons\WHITE8X8]], tile=true,
	...
	function Details:FormatCooltipForSpells()
		...
		GameCooltip:SetOption("StatusBarTexture", [[Interface\AddOns\DetailsWotlkPort\images\bar_background_dark_withline]])
		--GameCooltip:SetOption("StatusBarTexture", [[Interface\AddOns\DetailsWotlkPort\images\bar_textures\bar_rounded.png]])
	...
	function Details:PostBuildInstanceBarTooltip(actorObject)
		...
		if (not Details.GameCooltipFrame1Shadow) then
			...
			Details.GameCooltipFrame1Shadow:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\shadow_square.png]], nil, nil, "TRILINEAR")
