			...
			if (self.id) then
				...
				if (instanceObject.row_info.use_spec_icons) then
					...
					if (specId and _detalhes.class_specs_coords[specId]) then
						...
						thisBar.icone_classe:SetTexture([[Interface\AddOns\DetailsWotlkPort\images\classes_small]])
		...
		local CC_Done = {
			...
			tooltip = [[
				...
				for index, target in ipairs(targets) do
					...
					GameCooltip:AddIcon ("Interface\\AddOns\\DetailsWotlkPort\\images\\classes_small_alpha", 1, 1, _detalhes.tooltip.line_height, _detalhes.tooltip.line_height, l, r, t, b)
				    else
