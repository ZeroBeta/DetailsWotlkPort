...
function DetailsMythicPlusFrame.MergeSegmentsOnEnd() --~merge
    ...
    if (lower_instance) then
        ...
        if (instance) then
            ...
            instance:InstanceAlert ("Showing Mythic+ Run Segment", {[[Interface\AddOns\DetailsWotlkPort\images\icons]], 16, 16, false, 434/512, 466/512, 243/512, 273/512}, 6, func, true)
        end
    end
