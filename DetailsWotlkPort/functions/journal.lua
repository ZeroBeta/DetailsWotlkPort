        ...
        if (sectionInfo and type(sectionInfo) == "table") then
            ...
            if (spellId) then
                ...
                if (topDamage and topDamage > 0) then
                    ...
                    gameCooltip:SetOption("StatusBarTexture", [[Interface\AddOns\DetailsWotlkPort\images\bar_hyanda]])
                    ...
                    for i = 1, #damageDoneTable do
                        ...
                        gameCooltip:AddStatusBar(damageDone / topDamage * 100, 1, .5, .5, .5, 1, false, {value = 100, color = {.2, .2, .2, 0.9}, texture = [[Interface\AddOns\DetailsWotlkPort\images\bar_hyanda]]})
                    end
