...
function Details222.AutoRunCode.RecompileAutoRunCode()
    ...
    local codeTable = Details222.AutoRunCode.CodeTable or {}
...
function Details222.AutoRunCode.StartAutoRun()
    local newData = detailsFramework.table.copy({}, Details.run_code or {})
    Details.run_code = nil
    Details222.AutoRunCode.CodeTable = newData or {}
