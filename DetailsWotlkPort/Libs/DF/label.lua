...
function detailsFramework:NewLabel(parent, container, name, member, text, font, size, color, layer)
	...
	-- Retail-only font objects don't exist in Wrath; fall back to closest match.
	if (not _G[font]) then
		if (font == "OptionsFontHighlightSmall") then
			font = "GameFontHighlightSmall"
		elseif (font == "OptionsFontHighlight") then
			font = "GameFontHighlight"
		elseif (font == "OptionsFontNormal") then
			font = "GameFontNormal"
		end
	end
