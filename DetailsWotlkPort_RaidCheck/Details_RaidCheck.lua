...
local CreatePluginFrames = function()
	...
	local eatingFoodIcon = {texture = [[Interface\AddOns\DetailsWotlkPort\images\icons]], coords = {225/512, 249/512, 35/512, 63/512}}
...
function DetailsRaidCheck:OnEvent(_, event, ...)
	...
	elseif (event == "ADDON_LOADED") then
		...
		if (AddonName == "DetailsWotlkPort_RaidCheck" or AddonName == "Details_RaidCheck") then
			if (_G.Details) then
